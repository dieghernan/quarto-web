...
Let’s take a look at the source code for this example. First we create an `{ojs}` cell that reads in some data from a CSV file (*e.g.*, [`palmer-penguins.csv`](palmer-penguins.csv)) using a [FileAttachment](https://observablehq.com/@observablehq/file-attachments):
...
That covers a basic end-to-end use of OJS (see the [Penguins](../../docs/interactive/ojs/examples/penguins.llms.md) examples for the full source code).

> **TIP:**
>
> If you take a look at the [Penguins](../../docs/interactive/ojs/examples/penguins.llms.md) code, you’ll notice something curious: the inputs and plotting code are defined *before* the data processing code. This demonstrates a critical difference between OJS cell execution and traditional notebooks: cells do not need to be defined in any particular order.
>
...
Using other JavaScript libraries is also straightforward, they just need to be explicitly imported. For example, here we import a some libraries using the [require](https://github.com/observablehq/stdlib#require) function (which in turn loads NPM modules from [jsDelivr](https://www.jsdelivr.com/)):
...
See the article on [Libraries](../../docs/interactive/ojs/libraries.llms.md) to learn more about using standard and third-party libraries.
...
See the article on [Data Sources](../../docs/interactive/ojs/data-sources.llms.md) to learn more about the various ways to prepare and read data.
...
To learn about all of the options available, see the article on [OJS Cells](../../docs/interactive/ojs/ojs-cells.llms.md).

In addition to OJS cells which interupt the flow of markdown, you can also include code inline. Read more about inline code in the [Inline Code](../../docs/computations/inline-code.llms.md) article.

## Learning More

These articles go into more depth on using OJS in Quarto documents:

- [Libraries](../../docs/interactive/ojs/libraries.llms.md) covers using standard libraries and external JavaScript libraries.

- [Data Sources](../../docs/interactive/ojs/data-sources.llms.md) outlines the various ways to read and pre-process data.

- [OJS Cells](../../docs/interactive/ojs/ojs-cells.llms.md) goes into more depth on cell execution, output, and layout.

- [Shiny Reactives](../../docs/interactive/ojs/shiny.llms.md) describes how to integrate Shiny with OJS.

- [Code Reuse](../../docs/interactive/ojs/code-reuse.llms.md) delves into ways to re-use OJS code across multiple documents.
