...
For Jupyter, Quarto uses the same syntax for defining parameters as [Papermill](https://papermill.readthedocs.io/en/latest/usage-parameterize.llms.md). To parameterize a document, designate a cell with the tag `parameters` and provide appropriate default values:
