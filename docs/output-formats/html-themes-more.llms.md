...
Quarto supports [**brand.yml**](https://posit-dev.github.io/brand-yml/brand/defaults.llms.md), see the [Brand guide](../../docs/authoring/brand.llms.md) for more details. By default, styling information in `_brand.yml` takes the lowest precedence. To change this, use the `"brand"` string in your theme configuration in YAML:
