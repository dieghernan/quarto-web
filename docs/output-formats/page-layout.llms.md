...
![Screenshot of a Quarto website displaying the default layout of the sidebar, body and margin.](images/grid-default.png)

Default Layout

![Screenshot of a Quarto website with altered layout, devoting more space to the sidebar.](images/grid-wide-sidebar.png)
...
![A screenshot of a page in the Quarto documentation site, with rectangles drawn around the sidebar, body and margin, and arrows indicating the gutters between them.](images/grid.png)
...
Default values for the width of layout components {.caption-top .table}
...
Similarly, in a [custom theme `scss` file](../../docs/output-formats/html-themes.llms.md#theme-options), you may set variables like:
...
![Screenshot of a Quarto website with altered layout, devoting more space to the margin.](images/grid-wide-margin.png)
...
![Screenshot of a Quarto website with altered layout, devoting more space to the margin and less to the body.](images/grid-wide-margin-narrow-body.png)
