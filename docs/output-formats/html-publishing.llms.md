...
Note that it’s also possible to publish collections of Quarto documents as a website. See the article on [Publishing Basics](../../docs/publishing/index.llms.md) for additional details.

## Publish Command

The `quarto publish` command provides a straightforward way to publish documents to [Quarto Pub](../../docs/publishing/quarto-pub.llms.md), [GitHub Pages](../../docs/publishing/github-pages.llms.md), [Netlify](../../docs/publishing/netlify.llms.md), and [Posit Connect](../../docs/publishing/rstudio-connect.llms.md).
...
| [Other Services](../../docs/publishing/other.llms.md) | Content rendered with Quarto uses standard formats (HTML, PDFs, MS Word, etc.) that can be published anywhere. Use this if one of the methods above don’t meet your requirements. |
