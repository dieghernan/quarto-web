...
- `document`: embedded reports
  ...
  If you wish to use this feature, we recommend adding it to a “debug” [project profile](../../docs/projects/profiles.llms.md) to reduce the chance you will accidentally publish a website to production with these reports.
...
Currently, this feature requires users to open the webpage in a [local preview](../../docs/websites/index.llms.md#website-preview), and it uses a CDN to load the `axe-core` library itself.
