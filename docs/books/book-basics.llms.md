...
HTML books are actually just a special type of [Quarto Website](../../docs/websites/index.llms.md) and consequently support all of the same features as websites including full-text search. The most important difference is that HTML books use chapter numbers and therefore support [Cross References](../../docs/authoring/cross-references.llms.md) between different chapters.
...
Quarto books can be published to a wide variety of destinations including GitHub Pages, Netlify, RStudio Connect, or any other static hosting service or intranet web server. See the documentation on [Publishing Websites](../../docs/publishing/index.llms.md) for additional details.
...
![](../../docs/websites/images/positron-create-project-command-dark.png)![](../../docs/websites/images/positron-create-project-command.png)

Then, select **Book Project**:

![](images/positron-create-project-book-dark.png)![](images/positron-create-project-book.png)
...
![](../../docs/websites/images/positron-create-project-directory-dark.png)![](../../docs/websites/images/positron-create-project-directory.png)

The new book project will be created and opened within Positron. Click the **Preview** button (![Preview icon](../../docs/tools/images/vscode-preview-icon.svg)![Preview icon](../../docs/tools/images/vscode-preview-icon-white.svg)) to preview the book:

![](images/positron-create-project-render-book-dark.png)![](images/positron-create-project-render-book.png)
...
![](../../docs/websites/images/vscode-create-project-book.png)

You’ll be prompted to select a parent directory to create the project within. Then, you’ll be asked to name the directory for your book project:

![](../../docs/websites/images/vscode-create-project-directory.png)

The new book project will be created and opened within VS Code. Click the **Preview** button (![Preview icon](../../docs/tools/images/vscode-preview-icon.svg)![Preview icon](../../docs/tools/images/vscode-preview-icon-white.svg)) to preview the book:
...
![](../../docs/websites/images/rstudio-project-new-directory.png)

![](../../docs/websites/images/rstudio-project-book.png)

Then, provide a directory name and other relevant options for the book:

![](../../docs/websites/images/rstudio-project-book-options.png)
...
See the [Project Basics](../../docs/projects/quarto-projects.llms.md) article to learn more about working with projects, including how to add custom pre and post render scripts to your book.
...
See the documentation on [Publishing Websites](../../docs/publishing/index.llms.md) for details on how to publish books to GitHub Pages, Netlify, and other services. Note that in that documentation the `output-dir` may be referred to as `_site`: for publishing books you should use `_book` rather than `_site`.
...
- [Book Structure](../../docs/books/book-structure.llms.md) delves into different ways to structure a book (numbered and unnumbered chapters/sections, creating multiple parts, adding appendices, etc.)

- [Book Crossrefs](../../docs/books/book-crossrefs.llms.md) explains how to create cross references to sections, figures, tables, equations and more within books.

- [Book Output](../../docs/books/book-output.llms.md) covers customizing the style and appearance of your book in the various output formats as well as how to provide navigation and other tools for readers.

- [Book Options](../../docs/reference/projects/books.llms.md) provides a comprehensive reference to all of the available book options.

- [Code Execution](../../docs/projects/code-execution.llms.md) provides tips for optimizing the rendering of books with large numbers of documents or expensive computations.

- [Publishing Websites](../../docs/publishing/index.llms.md) enumerates the various options for publishing your book as a website including GitHub Pages, Netlify, and RStudio Connect.
