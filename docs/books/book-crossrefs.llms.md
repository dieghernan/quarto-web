...
If you aren’t already familiar with using crossrefs you may want to read the documentation on [cross references](../../docs/authoring/cross-references.llms.md) before reading on about how they work with books.
