...
- The `references.qmd` file will include the generated bibliography (see [References](#references) below for details).
...
You can mix together numbered and unnumbered chapters. Note however that while you can link to unnumbered chapters, you can’t [cross reference](../../docs/authoring/cross-references.llms.md) figures, tables, etc. within them. Unnumbered chapters are therefore mostly useful for prefatory content or references at the end of your book.
...
![A screenshot of the welcome page of a book rendered with Quarto. In the sidebar, content is separated by three different bold section titles. From top to bottom, these are: 'PROJECT 1: WEIGHTED DICE', 'PROJECT 2: PLAYING CARDS', and 'APPENDICES.'](images/book-parts-appendices.png)
