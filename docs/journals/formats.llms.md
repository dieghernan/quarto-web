...
- [Article Templates](../../docs/journals/templates.llms.md)

- [Authors & Affiliations](../../docs/journals/authors.llms.md)
...
- The `partials` directory contains some `.tex` files that override various parts of the standard Pandoc LaTeX template (see [Article Templates](../../docs/journals/templates.llms.md) to learn more about partials).
...
Note that the schema for author information used here is relatively straightforward. See the article on [Authors & Affiliations](../../docs/journals/authors.llms.md) to learn about more sophisticated schemas for author information.
...
- In depth treatment of creating [Article Templates](../../docs/journals/templates.llms.md) for Journals (including how to use partials to compose templates)

- Review of the schema and options for expressing and rendering [Authors & Affiliations](../../docs/journals/authors.llms.md).
