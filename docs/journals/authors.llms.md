...
Below we’ll explore these facilities in more detail from the standpoint of template authors. To learn more about these facilities from the perspective of article writers, see [Authors & Affiliations](../../docs/authoring/front-matter.llms.md#authors-and-affiliations).
