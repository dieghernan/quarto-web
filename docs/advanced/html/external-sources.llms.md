# External servers used by Quarto documents
...
However, on occasion, these documents might access resources hosted in external servers. The following is a list of such situations:
