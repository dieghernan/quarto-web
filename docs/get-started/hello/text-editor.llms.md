...
![On the left: A VS Code notebook titled Quarto Basics containing some text, a code cell, and the result of the code cell, which is a line plot on a polar axis. On the right: Rendered version of the same notebook.](images/text-editor-quarto-preview.png)
...
![Side-by-side preview of notebook on the left and live preview in the browser on the right.](images/text-editor-quarto-preview.png)
...
- [Tutorial: Computations](../../../docs/get-started/computations/text-editor.llms.md) — Learn how to tailor the behavior and output of executable code blocks.

- [Tutorial: Authoring](../../../docs/get-started/authoring/text-editor.llms.md) — Learn more about output formats and technical writing features like citations, crossrefs, and advanced layout.
