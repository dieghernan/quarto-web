...
Next, check out the [Authoring Tutorial](../../../docs/get-started/authoring/neovim.llms.md) to learn more about output formats and technical writing features like citations, crossrefs, and advanced layout.
