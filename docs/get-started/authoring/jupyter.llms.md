...
![Notebook formats.ipynb with a dropdown shown for a cell with three options: Code, Markdown, and Raw. Raw is highlighted.](images/jupyter-raw-cell.png)
...
![](images/jupyter-format-options.png)
...
![](images/jupyter-sections.png)

Here’s what this document looks like when rendered to HTML.

![Document with title Quarto Basics, author, and date. Table of contents is on the left-hand side with numbered items for each of the three sections: 1. Colors, 2. Shapes, 3. Textures. Each section is shown in the document with the list contents from the source ipynb.](images/sections-render.png)
...
![](../../../docs/get-started/authoring/images/jupyter-equation.png)

Equations are rendered when you run the cell.

![Rendered notebook with LaTeX equation shown for E equals mc squared.](../../../docs/get-started/authoring/images/jupyter-equation-render.png)
...
![](../../../docs/get-started/authoring/images/jupyter-citations.png)
...
![Rendered notebook with references section at the bottom the content of which reads 'Knuth, Donald E. 1984. Literate Programming. The Computer Journal 27 (2): 97-111.'](../../../docs/get-started/authoring/images/citations-render.png)
...
![](../../../docs/get-started/authoring/images/jupyter-crossref.png)
...
![](../../../docs/get-started/authoring/images/jupyter-callout.png)
