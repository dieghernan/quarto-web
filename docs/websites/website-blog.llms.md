...
![](images/positron-create-project-blog-dark.png)![](images/positron-create-project-blog.png)
...
The new blog project will be created and opened within Positron. Click the **Preview** button (![Preview icon](../../docs/tools/images/vscode-preview-icon.svg)![Preview icon](../../docs/tools/images/vscode-preview-icon-white.svg)) to preview the blog:

![](images/positron-create-project-render-blog-dark.png)![](images/positron-create-project-render-blog.png)
...
![](images/vscode-create-project-blog.png)

You’ll be prompted to select a parent directory to create the project within. Then, you’ll be asked to name the directory for your blog project:

![](images/vscode-create-project-directory.png)

The new blog project will be created and opened within VS Code. Click the **Preview** button (![Preview icon](../../docs/tools/images/vscode-preview-icon.svg)![Preview icon](../../docs/tools/images/vscode-preview-icon-white.svg)) to preview the blog:
...
![](images/rstudio-project-blog.png)

Then, provide a directory name and other relevant options for the blog:

![](images/rstudio-project-blog-options.png)
...
The home page is a [listing page](../../docs/websites/website-listings.llms.md) for all of the documents in the `posts` directory:

![Screenshot of a blog page. There is a navigation bar at the top with the blog title ('myblog') on the left, and on the right: 'About', a GitHub icon, a Twitter icon, and a Search icon. The body has two posts listed with titles, tags, description and preview ordered by date. On the right of the body are categories with counts of posts next to them.](images/myblog.png)
...
See the article on [Listing Pages](../../docs/websites/website-listings.llms.md) to learn more about customizing listings, including use a grid layout rather than the default shown above.
...
See the article on [Categories](../../docs/websites/website-listings.llms.md#categories) to learn more.

## About Page

The `about.qmd` document includes additional information on the blog and its author. For example:

![Screenshot of an about page. It has a large round circle in the top center with an image shown. Below that is a name in large type, with smaller placeholder body text beneath it. There are two buttons at the bottom, one for twitter, and one for GitHub.](images/about-jolla.png)
...
See the article on [About Pages](../../docs/websites/website-about.llms.md) to learn about the various options available for customizing page output.
...
Draft posts will appear when you preview the site, but will be blank when you render the site and will not appear in listings, navigation, the site map, or site search. You can read more about drafts in [Website Drafts](../../docs/websites/website-drafts.llms.md).
...
In the default blog we include a file (`_metadata.yml`) that establishes [shared metadata](../../docs/projects/quarto-projects.llms.md#shared-metadata) for all documents within the `posts` directory. In this file, we specify that we want `freeze: true` set by default for all posts:
...
See the article on the [`freeze`](../../docs/projects/code-execution.llms.md#freeze) option to learn more about freezing computational output within websites.

## Themes

Blogs can use any of the 25 [Bootswatch](https://bootswatch.com/) themes included with Quarto. You can also [create your own](../../docs/output-formats/html-themes.llms.md#theme-options) themes. The default blog generated by `quarto create project` uses the [cosmo](https://bootswatch.com/cosmo/) theme. Here are links to the available themes along with thumbnails of what the simple default blog looks like under a few of them:
...
[![Screenshot of blog with litera theme.](images/theme-litera.png)](https://bootswatch.com/litera/)

**solar**

[![Screenshot of blog with solar theme.](images/theme-solar.png)](https://bootswatch.com/solar/)

**morph**

[![Screenshot of blog with morph theme.](images/theme-morph.png)](https://bootswatch.com/morph/)
...
Now, when your site is rendered, an RSS feed will also be generated. To learn more, see the article on [RSS Feeds](../../docs/websites/website-listings.llms.md#feeds).
...
The article on [Publishing Websites](../../docs/publishing/index.llms.md) describes in more detail how to publish to the following services:

- [Quarto Pub](../../docs/publishing/quarto-pub.llms.md)
- [GitHub Pages](../../docs/publishing/github-pages.llms.md)
- [Netlify](../../docs/publishing/netlify.llms.md)
- [Posit Connect](../../docs/publishing/rstudio-connect.llms.md)
- [Firebase](../../docs/publishing/other.llms.md#google-firebase)
- [Site44](../../docs/publishing/other.llms.md#site44)
- [Amazon S3](../../docs/publishing/other.llms.md#amazon-s3)
...
![Screenshot of blog with a Subscribe section in the top of the right-hand section of the bofy. There is an input field marked 'email address' and a button below it labelled 'Subscribe'.](images/myblog-subscribe.png)
