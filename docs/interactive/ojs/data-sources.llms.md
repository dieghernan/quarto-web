...
Use the [FileAttachment](https://github.com/observablehq/stdlib#file-attachments) function from the standard library to read data from a file. For example, here we read and plot a CSV of NOAA’s Monthly [CO2 concentration data](https://gml.noaa.gov/ccgg/trends/data.llms.md) from Mauna Loa:
...
See the [NOAA C02](../../../docs/interactive/ojs/examples/noaa-co2.llms.md) example for the full source code.
...
See the [GitHub API](../../../docs/interactive/ojs/examples/github.llms.md) example for the full source code.
