...
3.  Incorporate [Jupyter Widgets](../../docs/interactive/widgets/jupyter.llms.md) or [htmlwidgets](../../docs/interactive/widgets/htmlwidgets.llms.md) (for the Jupyter and Knitr engines, respectively) into your document.
...
[ ](_w_3fd146897f6b4f8093757a4a80323f0b/#)
...
Shiny makes it very straightforward to create interactive documents using only R. Unlike using JavaScript though, you will need to [deploy](../../docs/interactive/shiny/running.llms.md#deployment) documents that use Shiny to a server.
...
- [Jupyter Widgets](../../docs/interactive/widgets/jupyter.llms.md) (Jupyter engine).

- [htmlwidgets](../../docs/interactive/widgets/htmlwidgets.llms.md) (Knitr engine).

## Layout

Once you’ve gotten familiar with using various interactive components see the article on [Component Layout](../../docs/interactive/layout.llms.md) to learn how to:

- Group inputs into an [input panel](../../docs/interactive/layout.llms.md#input-panel).

- Present multiple outputs in a [tabset panel](../../docs/interactive/layout.llms.md#tabset-panel).

- Use a [full page layout](../../docs/interactive/layout.llms.md#full-page-layout) rather than the default article layout.

- Add a [sidebar panel](../../docs/interactive/layout.llms.md#sidebar-panel) for inputs in a full page layout.

- Create custom [panel layouts](../../docs/interactive/layout.llms.md#panel-layout) to arrange outputs into rows and columns.
