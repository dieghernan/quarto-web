...
![](images/application-panel-layout.png)

As described in the article on [Figures](../../docs/authoring/figures.llms.md#complex-layouts), you can arrange panels of figures in very flexible fashion using the `layout` attribute. For the example above we enclosed the three visualizations in the following div:
