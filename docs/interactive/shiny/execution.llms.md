...
2.  Creating reactive values intended to be shared across sessions (e.g. with [reactivePoll](http://shiny.rstudio.com/reference/shiny/latest/reactivePoll.llms.md) or [reactiveFileReader](http://shiny.rstudio.com/reference/shiny/latest/reactiveFileReader.llms.md)).
