...
We’ll cover running and deploying Quarto documents with Shiny components in the article on [Running Documents](../../../docs/interactive/shiny/running.llms.md). Before that though, let’s cover a more in-depth example.

## Custom Layout

Here’s an example that includes multiple inputs as well as a more application like page layout with a sidebar:

![](images/iris-k-means.png)
...
See the article on [Component Layout](../../../docs/interactive/layout.llms.md) to learn more about the available tools for managing the layout of interactive documents.
...
- [Running Documents](../../../docs/interactive/shiny/running.llms.md) covers how to run interactive documents both within RStudio and at the command line, as well as how to deploy them to end users.

- [Execution Contexts](../../../docs/interactive/shiny/execution.llms.md) goes in depth on when different code blocks (e.g. rendering vs. serving) run as well as how to cache expensive computations for more responsive documents.

- [External Resources](../../../docs/interactive/shiny/resources.llms.md) describes how to make sure that Shiny can locate resources (e.g. CSS, JS, images, etc.) that you include in your document.

- [Component Layout](../../../docs/interactive/layout.llms.md) enumerates the various techniques you can use to layout interactive components within your documents.

If you are using both JavaScript and Shiny to create interactive documents, you might also be interested in the article on using [Shiny Reactives with OJS](../../../docs/interactive/ojs/shiny.llms.md).
