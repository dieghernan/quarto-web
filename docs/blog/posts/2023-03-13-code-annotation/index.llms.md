...
![Screenshot of output in PDF format showing code annotation.](annote-pdf.png)
...
You can read more about how to control the annotation style, and whether annotations appear at all on the [Code Annotation page](../../../../docs/authoring/code-annotation.llms.md) of the pre-release highlights.
