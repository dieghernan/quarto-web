...
Read more in the updated [Guide \> Brand](../../../../docs/authoring/brand.llms.md):

- [Light and dark colors](../../../../docs/authoring/brand.llms.md#light-and-dark-colors)
- [Light and dark logos](../../../../docs/authoring/brand.llms.md#light-and-dark-logos)
- [Brand mode](../../../../docs/authoring/brand.llms.md#brand-mode)
...
Read more in [Extensions \> Brand](../../../../docs/extensions/brand.llms.md), and keep an eye out for other ways to reuse and share your brand in future releases.
...
![A webpage with a box in the bottom left that warns 'Serious: Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds'.](../../../../docs/output-formats/images/axe-violation.png)

A rendered webpage with an accessibility violation warning

![A webpage with a box in the bottom left that warns 'Serious: Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds'.](../../../../docs/output-formats/images/axe-violation.png)

A rendered webpage with an accessibility violation warning

Read about your options in [HTML Accessibility Checks](../../../../docs/output-formats/html-accessibility.llms.md)
...
Read more in [Access execution settings from code cells](../../../../docs/advanced/quarto-execute-info.llms.md).
