Quarto 1.5 is out! You can find the current release on the [download page](../../../../docs/download/index.llms.md).
...
You can read more about using CSS in Typst at [Typst Basics: Typst CSS](../../../../docs/output-formats/typst.llms.md#typst-css).
...
Read more at [Website Drafts](../../../../docs/websites/website-drafts.llms.md).
...
![Screenshot of the quarto documentation showing a blue bar below the navbar, starting with the text 'Alert:...'.](images/website-announcement.png)

An example announcement bar

Read about your options at [Website Tools: Announcement Bar](../../../../docs/websites/website-tools.llms.md#announcement-bar).
...
Read about the details in [Using the `julia` engine](https://quarto.org/docs/computations/julia.llms.md#using-the-julia-engine).
...
Read more about their options at [Placeholder Images](../../../../docs/authoring/placeholder.llms.md) and [Placeholder Text](../../../../docs/authoring/lipsum.llms.md).
...
The balloon emoji in the [listing and social card image](images/thumbnail.png) for this post comes from [OpenMoji](https://openmoji.org/)– the open-source emoji and icon project. License: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/#)
