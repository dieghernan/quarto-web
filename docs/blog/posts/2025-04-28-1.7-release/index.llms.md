Quarto 1.7 is out! You can get the current release from the [download page](../../../../docs/download/index.llms.md).
...
![Screenshot of a webpage with a light blue body and charcoal text. A switch toggle in the navbar is 'off'.](light.png)

`light` brand

![Screenshot of a webpage with a dark charcoal body and light blue text. A switch toggle in the navbar is 'on'.](dark.png)
...
Read about other ways to set a light and dark brand in [Guide \> Brand](../../../../docs/authoring/brand.llms.md#dark-brand).
