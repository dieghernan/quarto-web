...
[![Shinylive application embedded in a Quarto document.](shinylive-embedded-app.png)](https://quarto-ext.github.io/shinylive/sine.llms.md)
...
Bear in mind that not all Shiny applications can be deployed with Shinylive, in part because not all Python packages can run in WebAssembly – but for those that can, this extension makes it possible to deploy the Quarto document with the embedded application on any web hosting service. To learn more about Shinylive, see [this page](https://shiny.posit.co/py/get-started/shinylive.llms.md).
