...
- [Quarto - Includes](../../../../docs/authoring/includes.llms.md)
- [Quarto - meta Variables](../../../../docs/authoring/variables.llms.md#meta)
- An overview of [Single Source Authoring](https://technicalwriterhq.com/writing/technical-writing/single-source-authoring/)
