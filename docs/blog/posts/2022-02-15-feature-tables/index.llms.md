...
This post provides an overview of these capabilities in Quarto. For more detail about all the features Quarto for authoring tables, see [Tables](../../../../docs/authoring/tables.llms.md).
...
In addition to the above, which focused on some of the features of Quarto when writing pipe tables in markdown, you can also author tables using grid syntax. You review the [documentation](../../../../docs/authoring/tables.llms.md). for more detail.
