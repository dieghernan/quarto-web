...
![Screenshot of a HTML page that includes a link to the Jupyter format below the table of contents under the heading Other Formats.](other-format.png)
...
Read more about this feature on the [Multi-format page](../../../../docs/output-formats/html-multi-format.llms.md) of the pre-release highlights.
