...
![Document with header reading: Summarizing Output for Reproducible Documents. Below is Author (Nora Jones), Affiliation (Spacely Sprockets), Published (5/4/2018). Below that is a description which reads: A summary of best practices for summarizing output of reproducible scientific documents.](images/document-title-block.png)
...
![Title block with title and description against a blue background up top, and below a section with author, affiliation, and date published.](images/document-title-block-banner.png)
...
![Title block with title and description against an image background up top, and below a section with author, affiliation, and date published.](images/document-title-block-banner-custom.png)
...
For more about date formats, see the Quarto [date format reference](../../docs/reference/dates.llms.md).
...
To learn more about providing a complete custom title block, see the [documentation on template partials](../../docs/journals/templates.llms.md#template-partials).
