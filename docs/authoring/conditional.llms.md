...
This feature is often useful alongside [project profiles](../../docs/projects/profiles.llms.md). Different profiles can set different metadata values, and so can control the metadata used in conditional content.
