...
| HTML | PDF | Word |
|----|----|----|
| ![A line drawing of an elephant.](images/html-figure.png) | ![A line drawing of an elephant.](images/pdf-figure.png) | ![A line drawing of an elephant.](images/word-figure.png) |

Note that for LaTeX / PDF output figures are automatically numbered (you can arrange for figures to be numbered in other formats using [Cross References](../../docs/authoring/cross-references.llms.md)).
...
To render the caption instead as alt text you can append a backslash to the line as detailed in [the Pandoc documentation](https://pandoc.org/MANUAL.llms.md#extension-implicit_figures):
...
[![An elephant](elephant.png)](elephant.png "An elephant")
...
For further details and other ways to enable and disable lightbox treatment see [Lightbox Figures](../../docs/output-formats/html-lightbox-figures.llms.md).
...
![An artistic rendition of Surus, Hannibal's last war elephant, is on the left. Underneath this picture is the caption '(a) Surus.' On the right is a line drawing of Hanno, a famous elephant. Underneath this picture is the caption '(b) Hanno.' The words 'Figure 1: Famous elephants' are centered beneath both pictures.](images/elephant-subfigures.png)
...
![An artistic rendition of Surus, Hannibal's last war elephant, is on the left. Underneath this picture is the caption 'Surus.' On the right is a line drawing of Hanno, a famous elephant. Underneath this picture is the caption 'Hanno.'](images/elephant-figures-no-subcaption.png)
...
![A 2x2 grid of pictures of elephants. There are labels underneath each of the pictures. Clockwise from the upper left, the labels say: Surus, Hanno, Lin Wang, and Abdul Abbas.](images/elephant-rows.png)
...
![Two pictures of elephants side by side. The picture on the left has the label 'Figure 1: Surus' underneath it. The picture on the right has the label 'Figure 2: Lin Wang' underneath it. The figure on the left is more than twice the width and height of the figure on the right.](images/valign.png)
...
Read more about these options in [Execution Options: Figure Options](../../docs/computations/execution-options.llms.md#figure-options).
...
![Two line plots rendered by Jupyter side-by-side.](images/jupyter-figure-layout.png)
...
![Two line plots with captions rendered by Jupyter side-by-side.](images/jupyter-figure-layout-caption.png)
...
![Two scatter plots with captions arranged side-by-side.](images/knitr-figure-layout-caption.png)
