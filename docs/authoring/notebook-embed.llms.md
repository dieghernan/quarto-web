...
![A screenshot of a Jupyter Notebook with the name 'penguins.ipynb', with a cell highlighted that has the code chunk option label set to fig-bill-scatter. Below the cell is the resulting plot.](images/notebook-simple.png)
...
[Source: Palmer Penguins (.ipynb)](penguins-preview.llms.md#cell-fig-bill-scatter)
...
![A screenshot of webpage with the title 'penguins.ipynb', a large blue button labelled 'Download Notebook', followed by the notebook contents.](images/notebook-view.png)
...
![](notebook-embed_files/figure-html/penguins-qmd-fig-size-scatter-output-1.png)

Figure 2

[Source: Palmer Penguins (.qmd)](penguins-qmd.embed-preview.llms.md#cell-fig-size-scatter)
...
![Screenshot of a code cell in a Jupyter Notebook with the cell tags open in the cell toolbar and displaying the tag 'bill-ratio'.](images/notebook-tag.png)
...
![A density plot of bill ratio by species.](notebook-embed_files/figure-html/penguins-cell-6-output-1.png)
...
![Density plot of bill depth by species.](notebook-embed_files/figure-html/penguins-fig-bill-marginal-output-1.png)

\(a\) Gentoo penguins tend to have thinner bills,

![Density plot of bill length by species.](notebook-embed_files/figure-html/penguins-fig-bill-marginal-output-2.png)
...
![Screenshot of a rendered page with an embedded plot. A link to the Source 'penguins.ipynb' is shown directly below the plot. A similar link is shown below the table of contents under the heading 'Notebooks'.](images/notebook-links.png)
...
As an example, you can view the live previews for the [`penguins.ipynb` notebook](penguins-preview.llms.md) and [`penguins.qmd` notebook](penguins-qmd.embed-preview.llms.md) used in this document.
...
![Screenshot of a rendered page with an embedded plot. A link to the Source 'Plots and Computations' is shown directly below the plot. A similar link is shown below the table of contents under the heading 'Notebooks'.](images/notebook-links-updated.png)
