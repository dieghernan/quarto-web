...
The `{{< meta >}}` syntax used here is an example of a [shortcode](../../docs/extensions/shortcodes.llms.md). Quarto supports the following shortcodes for dynamic variables:
...
You can read more about setting environment variables in Quarto projects in [Environment Variables](../../docs/projects/environment.llms.md).
