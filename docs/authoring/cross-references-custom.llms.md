...
You can then use this new type with the [Cross-Reference Div Syntax](../../docs/authoring/cross-references-divs.llms.md) in a document:
...
You can find a complete listing of the options available for the `custom` key on the [Cross-Reference Options](../../docs/reference/metadata/crossref.llms.md#custom) reference page.
