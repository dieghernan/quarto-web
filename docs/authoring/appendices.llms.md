...
![Appendix with two sections: References, and Footnotes.](images/document-appendix-simple.png)

To learn more about including document attribution information in the appendix, see [Creating Citeable Articles](../../docs/authoring/create-citeable-articles.llms.md).
...
![Appendix with Acknowledgements, References, Footnes, and Citation sections. The Citation section contains both BibTex citation, and plain text for attribution.](images/document-appendix-full.png)

## License

If you include a license in the front matter or citation information for your document, a ‘Reuse’ section will automatically be added to the appendix. Read more about specifying a license in [Front Matter](../../docs/authoring/front-matter.llms.md#license).
...
![Appendix with Acknowledgements, References, Footnotes, Reuse, and Citation sections. The Reuse section contains a link to the Attribution-ShareAlike Creative Commons license.](images/document-appendix-reuse.png)
