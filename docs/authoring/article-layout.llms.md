...
![Three walking elephants in silhouette against the backdrop of a sunset.](images/elephant.jpg)
...
![](article-layout_files/figure-html/unnamed-chunk-4-1.png)

![](article-layout_files/figure-html/unnamed-chunk-4-2.png)

![](article-layout_files/figure-html/unnamed-chunk-4-3.png)
...
![](article-layout_files/figure-html/fig-mtcars-1.png)
...
![](article-layout_files/figure-html/unnamed-chunk-7-1.png)
...
With these options set, footnotes and citations will (respectively) be automatically be placed in the margin of the document rather than the bottom of the page. As an example, when I cite Xie et al. ([2018](#ref-xie2018)), the citation bibliography entry itself will now appear in the margin.
...
![](article-layout_files/figure-html/fig-cap-margin-1.png)
