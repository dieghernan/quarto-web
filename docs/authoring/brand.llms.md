...
This is similar to how [Themes](../../docs/output-formats/html-themes.llms.md#dark-mode) work.
...
[Color in the **brand.yml** docs](https://posit-dev.github.io/brand-yml/brand/color.llms.md)
...
[Logo in the **brand.yml** docs](https://posit-dev.github.io/brand-yml/brand/logo.llms.md)
...
When using `format: typst` you can additionally [customize the logo position](../../docs/output-formats/typst.llms.md#logo-position).

### Typography

[Typography in the **brand.yml** docs](https://posit-dev.github.io/brand-yml/brand/typography.llms.md)
...
The properties you can set for a font under `fonts` depends on the `source`. You can see the other properties available in our [Reference for Brand](../../docs/reference/metadata/brand.llms.md#font-resource-definitions).
...
See [the Advanced documentation](../../docs/advanced/typst/brand-yaml.llms.md#typography) for more details on the Typst implementation, and troubleshooting tips for fonts.

### Defaults

[Defaults in the **brand.yml** docs](https://posit-dev.github.io/brand-yml/brand/defaults.llms.md)
...
The `bootstrap` section of `defaults` follows [**brand.yml**](https://posit-dev.github.io/brand-yml/brand/defaults.llms.md) and applies to the `html` and `dashboard` formats. Quarto merges the options set under `defaults: bootstrap` in the appropriate layer of [Quarto’s SCSS layering system](../../docs/output-formats/html-themes-more.llms.md).
...
[![Screenshot of a webpage. The text is dark grey on a light blue background, using a rounded sans-serif typeface, a logo appears in the navbar.](../../docs/authoring/images/brand-html-no-defaults.png)](../../docs/authoring/images/brand-html-no-defaults.png "Without defaults: bootstrap setting")

Without `defaults: bootstrap` setting

[![Screenshot of a webpage. It looks identical to the previous image, except for underlined links and white text on the navbar.](../../docs/authoring/images/brand-html-defaults.png)](../../docs/authoring/images/brand-html-defaults.png "With defaults: bootstrap setting: note the link decoration and the white color for the navbar text")
...
[Meta in the **brand.yml** docs](https://posit-dev.github.io/brand-yml/brand/meta.llms.md)
...
- For the `brand logo` shortcode, the default is `both`, which will expand to both light and dark logos with the appropriate [classes for mode-specific content](../../docs/output-formats/html-themes.llms.md#mode-specific-content) so that the light logo shows in light mode and the dark logo shows in dark mode.
...
Then the variable `$brand-blue` is will be set to `#ddeaf1` in the `defaults` layer of [Quarto’s SCSS layering system](../../docs/output-formats/html-themes-more.llms.md#bootstrap-bootswatch-layering). You can add a custom SCSS file, `styles.scss`, in the usual way:
...
You can learn more about layering themes in [More About Quarto Themes](../../docs/output-formats/html-themes-more.llms.md).
...
Quarto 1.8 introduces the [brand extension](../../docs/extensions/brand.llms.md), a Quarto-specific way to distribute brand metadata and assets using a Git repository.

Quarto extensions install to the `_extensions/` subdirectory of your project. You will have a copy of the brand metadata and assets in each project; use [`quarto update`](../../docs/extensions/managing.llms.md#updating) to update the brand extension from its repository.

Quarto 1.9 will introduce `quarto use brand` for a simpler way to share brands. Watch [this page on the prerelease documentation](https://prerelease.quarto.org/docs/authoring/brand.llms.md#sharing-brands-across-projects) for availability.
...
Learn more about how Quarto generates styles in [More About Quarto Themes](../../docs/output-formats/html-themes-more.llms.md).
