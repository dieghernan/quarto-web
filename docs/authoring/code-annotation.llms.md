...
![Screenshot of output in PDF format showing code annotation.](images/annote-pdf.png)
...
You can control the colors used to highlight lines in a custom theme with [Code Annotation Sass Variables](../../docs/output-formats/html-themes.llms.md#code-annotation).
