...
- [Input Layout](../../../../docs/dashboards/inputs.llms.md) describes various ways to layout inputs (sidebars, input panels, attaching inputs directly to cards, etc.).

- [Running Dashboards](../../../../docs/dashboards/interactivity/shiny-python/running.llms.md) covers how to run interactive dashboards both within VS Code, Positron, and at the command line, as well as how to deploy them to end users.
