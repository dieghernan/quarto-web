...
The [Shiny](https://shiny.posit.co/r/getstarted/shiny-basics/lesson1/index.llms.md) package provides an easy way to build web applications with R. Quarto dashboards can include embedded Shiny components (e.g. a plot with sliders that control its inputs).

This section covers integrating Shiny with Quarto and assumes that you already have basic familiarity with Shiny. To learn more about Shiny please visit [https://shiny.posit.co/r/getstarted/shiny-basics/lesson1/index.html](https://shiny.posit.co/r/getstarted/shiny-basics/lesson1/index.llms.md). If you are using Python rather than R, see the documentation on using [Shiny for Python](../../../docs/dashboards/interactivity/shiny-python/index.llms.md).
