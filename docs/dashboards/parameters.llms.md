...
Adding parameter definitions to a dashboard works differently depending on whether you are using the [Jupyter](https://jupyter.org), [Knitr](https://yihui.name/knitr) or Julia engine.

### Jupyter

For Jupyter, Quarto uses the same syntax for defining parameters as [Papermill](https://papermill.readthedocs.io/en/latest/usage-parameterize.llms.md). To parameterize a dashboard, designate a cell with the tag `parameters` and provide appropriate default values:
