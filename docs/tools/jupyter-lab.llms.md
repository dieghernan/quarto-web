...
![A Jupyter notebook with, from top to bottom, some yaml frontmatter, a section heading, a code block, and the output of the code block. The contents are the same as the first part of the 'Welcome' page of this website.](images/jupyter-lab.png)
...
![Two web browser windows arranged side by side. The window on the left is a JupyterLab window. The contents of this Jupyter document are rendered by Quarto in the window on the right.](images/jupyterlab-preview.png)
...
You can read more about installing the extension in the [Quarto JupyterLab Extension](../../docs/tools/jupyter-lab-extension.llms.md) documentation.
...
![The top section of a JupyterLab document. There is a Raw cell containing yaml front matter.](images/jupyter-lab-yaml.png)
...
![A snippet of a JupyterLab document containing a Markdown cell. The cell contains some text written in Markdown.](images/jupyter-lab-markdown.png)
...
![A snippet of a JupyterLab document containing a code cell. At the top of cell, before the code, are the Quarto chunk options '#\| label: fig-polar' and '#\| fig-cap: A line plot on a polar axis.'](images/jupyter-lab-output-options.png)
...
> **TIP:**
>
> If you are doing most of your work in .qmd files you should consider using RStudio, which includes full support for editing .qmd files that use Python and Jupyter (including code completion, cell-at-a-time execution, and side-by-side preview). See the article on using [RStudio](../../docs/tools/rstudio.llms.md) for additional details.
