...
2.  The [Visual Editor](../../../docs/tools/vscode/visual-editor.llms.md) for WYSIWYG editing of `.qmd` documents.

3.  The [Notebook Editor](../../../docs/tools/vscode/notebook.llms.md) for editing `.ipynb` notebooks.

We’ll cover the source code editor below, however you might also want to consult the documentation for the [Visual Editor](../../../docs/tools/vscode/visual-editor.llms.md) or [Notebook Editor](../../../docs/tools/vscode/notebook.llms.md) after you’ve become familiar with the basics.
...
![Two windows arranged side by side. The window on the left is a qmd file opened in VS. The contents of this document are the same as the first part of the Getting Started: Welcome section of this website. The contents of this document are rendered by Quarto in the window on the right.](../../../docs/tools/images/vscode-render-dark.png)

![Two windows arranged side by side. The window on the left is a qmd file opened in VS. The contents of this document are the same as the first part of the Getting Started: Welcome section of this website. The contents of this document are rendered by Quarto in the window on the right.](../../../docs/tools/images/vscode-render.png)
...
![The top of the VS editor. The right side of the editor tab area includes a Preview button.](../../../docs/tools/images/vscode-preview-button.png)

![The top of the VS editor. The right side of the editor tab area includes a Preview button.](../../../docs/tools/images/vscode-preview-button-dark.png)
...
![The top of the VS editor. The editor title menu is expanded and the Preview Format command is available on the menu.](../../../docs/tools/images/vscode-preview-format-menu.png)

![The top of the VS editor. The editor title menu is expanded and the Preview Format command is available on the menu.](../../../docs/tools/images/vscode-preview-format-menu-dark.png)
...
![The top of the VS editor. The command pallette shows a quick pick list of available formats to preview.](../../../docs/tools/images/vscode-preview-format.png)

![The top of the VS editor. The command pallette shows a quick pick list of available formats to preview.](../../../docs/tools/images/vscode-preview-format-dark.png)
...
![The top of the VS editor. The command palette shows a quick pick list of available formats to render.](../../../docs/tools/images/vscode-render-command.png)

![The top of the VS editor. The command palette shows a quick pick list of available formats to render.](../../../docs/tools/images/vscode-render-command-dark.png)
...
![The VS Quarto render settings. The Render on Save option is checked.](../../../docs/tools/images/vscode-render-on-save.png)

![The VS Quarto render settings. The Render on Save option is checked.](../../../docs/tools/images/vscode-render-on-save-dark.png)
...
![VS settings interface with 'quarto preview type' entered into the search bar. User settings reveals Quarto \> Render: Preview Type, with a dropdown to select location for document preview after render. The default, internal, is selected, which previews using a side-by-side panel in VS. The other two options in the dropdown are external and none.](../../../docs/tools/images/vscode-preview-settings.png)
...
![A Quarto document in VS with a python code cell. There is a code completion helper active in the python cell.](../../../docs/tools/images/vscode-code-cell.png)

![A Quarto document in VS with a python code cell. There is a code completion helper active in the python cell.](../../../docs/tools/images/vscode-code-cell-dark.png)
...
![VS with two panes open, source code on the right, and the interactive output of that code shown in a second pane on the left.](../../../docs/tools/images/vscode-execute-cell.png)

![VS with two panes open, source code on the right, and the interactive output of that code shown in a second pane on the left.](../../../docs/tools/images/vscode-execute-cell-dark.png)
...
![Screenshot of VS editor with three vertical sections. The leftmost includes the file explorer, and quarto help. The second pane is the source code for a quarto file with python code. The third is interactive with Python running and output of the code cells shown.](../../../docs/computations/images/python-vscode.png)
...
![Quarto document open in VS with a LaTeX equation shown in the 'Quarto Equation' section of the panel to the left of the document.](../../../docs/tools/images/vscode-equation.png)

![Quarto document open in VS with a LaTeX equation shown in the 'Quarto Equation' section of the panel to the left of the document.](../../../docs/tools/images/vscode-equation-dark.png)

Here we see a Graphviz diagram preview automatically updated as we edit:

![A Quarto document being edited in VS, with a live preview of the currently edited diagram shown in a pane to the right](../../../docs/authoring/images/vscode-graphviz.gif)

## YAML Intelligence

YAML code completion is available for project files, YAML front matter, and executable cell options:

![Quarto document with YAML being edited. Next to the cursor code completion helper is open showing YAML options beginning with the letters preceding the cursor ('co').](../../../docs/tools/images/vscode-yaml-completion.png)

![Quarto document with YAML being edited. Next to the cursor code completion helper is open showing YAML options beginning with the letters preceding the cursor ('co').](../../../docs/tools/images/vscode-yaml-completion-dark.png)

If you have incorrect YAML it will also be highlighted when documents are saved:

![Quarto document YAML metadata with an incorrect option underlined in red.](../../../docs/tools/images/vscode-yaml-diagnostics.png)

![Quarto document YAML metadata with an incorrect option underlined in red.](../../../docs/tools/images/vscode-yaml-diagnostics-dark.png)
...
![Quarto document with dropdown 'Select a snippet' dropdown, the first item (bold - insert bold text) is selected.](../../../docs/tools/images/vscode-snippets.png)

![Quarto document with dropdown 'Select a snippet' dropdown, the first item (bold - insert bold text) is selected.](../../../docs/tools/images/vscode-snippets-dark.png)
...
![Quarto document with outline view shown in left-hand panel. The outline shows the section headers of the quarto documents.](../../../docs/tools/images/vscode-outline.png)

![Quarto document with outline view shown in left-hand panel. The outline shows the section headers of the quarto documents.](../../../docs/tools/images/vscode-outline-dark.png)
...
![Quarto document in VS with command palette open showing the files in the project with the entered term, 'margin'.](../../../docs/tools/images/vscode-workspace-symbols.png)

![Quarto document in VS with command palette open showing the files in the project with the entered term, 'margin'.](../../../docs/tools/images/vscode-workspace-symbols-dark.png)
...
1.  The [Visual Editor](../../../docs/tools/vscode/visual-editor.llms.md) for WYSIWYG editing of `.qmd` documents.

2.  The [Notebook Editor](../../../docs/tools/vscode/notebook.llms.md) for editing `.ipynb` notebooks.
