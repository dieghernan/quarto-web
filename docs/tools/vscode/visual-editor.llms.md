...
![VS with a document called \`libraries.qmd\` open in visual editing mode. The subtitle and list of items are typeset. The visual editing toolbar is visible at the top of the document.](../../../docs/tools/images/vscode-visual-editor.png)

![Positron with a document called \`libraries.qmd\` open in visual editing mode. The subtitle and list of items are typeset. The visual editing toolbar is visible at the top of the document.](../../../docs/tools/images/vscode-visual-editor-dark.png)
...
2.  Use the context menu from anywhere in a document:
    ...
    ![The context menu in with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/vscode-visual-editor-context-menu.png)

    ![The context menu in with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/vscode-visual-editor-context-menu-dark.png)

3.  Use the **Edit in Visual Mode** and **Edit in Source Mode** commands:

    ![The command palette with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/vscode-visual-mode-command.png)

    ![The command palette with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/vscode-visual-mode-command-dark.png)

4.  Use the editor menu:

    ![The editor menu with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/vscode-visual-mode-menu.png)

    ![The editor menu with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/vscode-visual-mode-menu-dark.png)
...
![](../../../docs/tools/images/vscode-visual-editor-default-mode.png)

![](../../../docs/tools/images/vscode-visual-editor-default-mode-dark.png)
...
![](../../../docs/tools/images/vscode-visual-editor-toolbar.png)
