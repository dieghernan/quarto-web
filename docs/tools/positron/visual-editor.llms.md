...
![Positron with a document called \`libraries.qmd\` open in visual editing mode. The subtitle and list of items are typeset. The visual editing toolbar is visible at the top of the document.](../../../docs/tools/images/positron-visual-editor.png)

![Positron with a document called \`libraries.qmd\` open in visual editing mode. The subtitle and list of items are typeset. The visual editing toolbar is visible at the top of the document.](../../../docs/tools/images/positron-visual-editor-dark.png)
...
2.  Use the context menu from anywhere in a document:
    ...
    ![The context menu in with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/positron-visual-editor-context-menu.png)

    ![The context menu in with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/positron-visual-editor-context-menu-dark.png)

3.  Use the **Edit in Visual Mode** and **Edit in Source Mode** commands:

    ![The command palette with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/positron-visual-mode-command.png)

    ![The command palette with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/positron-visual-mode-command-dark.png)

4.  Use the editor menu:

    ![The editor menu with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/positron-visual-mode-menu.png)

    ![The editor menu with the Edit in Visual Mode command highlighted.](../../../docs/tools/images/positron-visual-mode-menu-dark.png)
...
![](../../../docs/tools/images/positron-visual-editor-default-mode.png)

![](../../../docs/tools/images/positron-visual-editor-default-mode-dark.png)
...
![](../../../docs/tools/images/positron-visual-editor-toolbar.png)

Additional commands are available on the **Format**, **Insert**, and **Table** menus:

| Format | Insert | Table |
|----|----|----|
| ![The contents of the Format drop down menu.](../../../docs/tools/images/vscode-visual-editor-format-menu.png) | ![The contents of the Insert drop down menu.](../../../docs/tools/images/vscode-visual-editor-insert-menu.png) | ![The contents of the Table drop down menu.](../../../docs/tools/images/vscode-visual-editor-table-menu.png) |

## Editor Options

There are a variety of Positron options available to configure the behavior of the visual editor. You can locate these options by filtering on `quarto.visualEditor` in the settings pane:

![](../../../docs/tools/images/vscode-visual-editor-options.png)
...
![The 'Insert Citation' dialog. The 'My Library' option is selected. The search bar at the top of the right section is empty, but the search results section is filled with the contents of a Zotero reference manager library. Each of the search result icons has a small 'Z' on the bottom right to indicate that the result comes from a Zotero library.](../../../docs/visual-editor/images/visual-editing-citations-zotero-browse.png)

Zotero references will also show up automatically in visual editor completions:

![](../../../docs/visual-editor/images/visual-editing-citation-completions.png)
...
If you are running both Positron and Zotero on your desktop, then no additional configuration is required for connecting to your Zotero library. If however you want to access your Zotero library over the web, then a few more steps are required (see the [Zotero Web API](#zotero-web-api) section for details).
...
![](../../../docs/visual-editor/images/visual-editing-vscode-zotero-libraries.png)
...
If you don’t have Zotero installed locally, you can still access your Zotero library using the Zotero Web API (assuming you have a Zotero web account and have synced your libraries to your account).

> **TIP:**
>
> If you are running Positron on your desktop it’s generally easier to also run Zotero on your desktop and access your library locally. That said, it is possible to access Zotero web libraries from Positron on the desktop if you prefer that configuration.
...
![The Sync tab of Zotero preferences.](../../../docs/visual-editor/images/visual-editing-citations-zotero-sync.png)

Once you’ve configured your library to sync, you need to [create a Zotero API Key](https://www.zotero.org/settings/keys/new):

![The 'New Private Key' section of Zotero. The 'Allow library access' option is selected.](../../../docs/visual-editor/images/visual-editing-citations-zotero-keygen.png)
...
![](../../../docs/visual-editor/images/vscode-zotero-web-config.png)

You’ll then be promoted to enter your Zotero Web API Key:

![](../../../docs/visual-editor/images/visual-editing-zotero-vscode-setup.png)
...
1.  As a global or per-workspace Positron option (you can find the options that affect markdown output by filtering on `quarto.visualEditor.markdown`).

2.  Specifying them within document or project level YAML (described below).

#### Line Wrapping

By default, the visual editor writes Markdown with no line wrapping (paragraphs all occupy a single line). However, if you prefer to insert line breaks at a particular column (e.g. 72 or 80), or to insert a line break after each sentence, you can use the `quarto.visualEditor.markdownWrap` and `quarto.visualEditor.markdownWrapColumn` options accessible from the settings editor in Positron.
...
By default, references (footnotes and reference links) are written at the end of the block where their corresponding footnote appears. You can override this behavior using the `quarto.visualEditor.markdownReferences` Positron setting or by using the `references` option within document or project YAML.
...
> **NOTE:**
>
> Note that if you are within a Quarto [book](../../../docs/books/index.llms.md) project then a references `prefix` is applied automatically so no changes to `editor` options are required.
...
You can alternatively enable reference links using the Positron `quarto.visualEditor.markdownReferenceLinks` option.
