...
In addition to editing Quarto documents as plain-text `.qmd` files, you can also use the Positron Notebook Editor to author `.ipynb` notebooks that are rendered with Quarto. In this article we’ll review the basics of editing `.ipynb` notebooks for use with Quarto.

## Render and Preview

![](../../../docs/tools/images/positron-notebook.png)
...
![The top section of an ipynb file open in Positron. There is a Raw cell containing yaml front matter.](../../../docs/tools/images/vscode-raw.png)
