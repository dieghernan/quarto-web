...
|----|----|----|
| R | [renv](https://rstudio.github.io/renv/index.llms.md) | `renv.lock` |
| R | [Binder R Config](https://mybinder.readthedocs.io/en/latest/using/config_files.llms.md#install-r-install-an-r-rstudio-environment) | `install.R` |
...
Often these files are created as the result of using a virtual environment. See [Virtual Environments](../../docs/projects/virtual-environments.llms.md) for more about using Quarto with virtual environments.
...
You can read more about how Binder uses these configuration files in the [Binder documentation](https://mybinder.readthedocs.io/en/latest/using/config_files.llms.md#config-files).
...
![Screenshot of the Code Links section on a rendered HTML page showing a link with the text Launch Binder.](images/code-links-binder.png)
