...
To learn how to create and use a virtual environment, see the full documentation on [Virtual Environments](../../docs/projects/virtual-environments.llms.md)
...
You can use the `cache` option to cache the results of computations (using the [knitr cache](https://yihui.org/knitr/demo/cache/) for R documents, [Jupyter Cache](https://jupyter-cache.readthedocs.io/en/latest/) for Jupyter documents, or [`engine: julia`’s](../../docs/computations/julia.llms.md#caching-1) built-in support):
