...
Since a Quarto manuscript is a special type of Quarto website, you can publish it any way you can publish a Quarto website. If GitHub Pages doesn’t suit your needs you can learn about other options in [Publishing](../../docs/publishing/index.llms.md).
...
![Screenshot of GitHub repository settings, showing a checked box next to the option 'Read and Write Permission', under the Workflow Permissions heading.](images/github-action-setting.png)
...
>
> If you instead want your GitHub Action to also evaluate code, read how to set it up in the [Executing Code section on the Publishing to GitHub page](../../docs/publishing/github-pages.llms.md#executing-code).
...
![Screenshot of the Actions page on a template repo. Under Actions, two workflows are listed: Quarto Publish and pages-build-deployment. Under All Workflows the same workflows appear both showing a green checkmark.](images/github-publish-actions.png)
...
![Screenshot of GitHub Pages Settings: under the heading GitHub Pages a dialog starting with 'Your page is live at:' followed by a URL.](images/github-pages-url.png)

Your manuscript is now published!

## What Next?

You’ve now been through the full workflow of a Quarto manuscript: authoring content, previewing the generated manuscript and publishing it to GitHub Pages. When you are ready to dive into more detail, we have some recommendations on [Next Steps](../../docs/manuscripts/next-steps.llms.md).
