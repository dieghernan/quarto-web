...
- [Callouts](../../../docs/prerelease/1.3/custom-ast-nodes/callout.llms.md)
- [Tabsets](../../../docs/prerelease/1.3/custom-ast-nodes/tabset.llms.md)
- [Conditional Blocks](../../../docs/prerelease/1.3/custom-ast-nodes/conditional-block.llms.md)

## Example: Callouts

In previous versions of Quarto, callouts would be represented directly as a div with a class starting with `callout`, and the contents laid out in a [particular way](../../../docs/authoring/callouts.llms.md).
