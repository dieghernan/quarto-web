...
Quarto will recognize the `CNAME` file as a [site resource](../../docs/websites/website-tools.llms.md#site-resources) and will copy it your site output directory when you render.
