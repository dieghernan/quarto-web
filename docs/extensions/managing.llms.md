...
While it’s convenient to distribute extensions using GitHub, you can also bundle them into a `.zip` or `.tar.gz` archive and distribute them using a URL or a local file. See the article on [Distributing Extensions](../../docs/extensions/distributing.llms.md) for additional details.
