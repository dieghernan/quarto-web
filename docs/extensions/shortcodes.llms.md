...
- [Lua Development](../../docs/extensions/lua.llms.md) (Lua is the language used to create shortcodes).

- [Lua API Reference](../../docs/extensions/lua-api.llms.md), which describes the Lua extension API for Quarto. Specifically, consider consulting the `quarto.shortcode.*` entry points.
