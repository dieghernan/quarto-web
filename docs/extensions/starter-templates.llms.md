...
1.  Create a working initial document for [Journal Articles](../../docs/journals/index.llms.md) or [Custom Formats](../../docs/extensions/formats.llms.md).

2.  Provide the initial content for a custom [Project Type](../../docs/extensions/project-types.llms.md).
...
When creating [Journal Articles](../../docs/journals/index.llms.md), [Custom Formats](../../docs/extensions/formats.llms.md), or [Project Type](../../docs/extensions/project-types.llms.md) extensions, we recommend that you additionally provide a starter template to make it easy for users to get started.
