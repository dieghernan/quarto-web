...
Brand extensions are Quarto extensions that provide a [brand.yml](../../docs/authoring/brand.llms.md) file and its assets.

> **IMPORTANT:**
>
> Currently, brand extensions merge project-level metadata, so they can only be used with a `_quarto.yml` [project](../../docs/projects/quarto-projects.llms.md) present in the place where they are installed. This limitation may be lifted in the future.
