...
The [Quarto CLI](https://github.com/quarto-dev/quarto-cli) is licensed under the [MIT License](https://opensource.org/license/mit/) (version 1.4 and later) or the [GNU GPL v2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.llms.md) (version 1.3 and earlier).

### VS Code Extension and Visual Editor

The Quarto [VS Code extension](https://github.com/quarto-dev/quarto/tree/main/apps/vscode) and the [visual editor](https://github.com/quarto-dev/quarto/tree/main/packages/editor) used in VS Code, Positron, and RStudio are licensed under the [GNU AGPL v3](https://www.gnu.org/licenses/agpl-3.0.en.llms.md).
...
Quarto is a registered trademark of Posit. Please see our [trademark policy](trademark.llms.md) for guidelines on usage of the Quarto trademark.
